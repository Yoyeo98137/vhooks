...
import Retry from '@/packages/useRequest/doc/retry/index.vue';
...
export const routes = [
  ...
  { path: '/useRequest/basic', name: 'requestBasic', component: Basic },
  {
    ...
    name: 'requestLoadingDelay',
    component: LoadingDelay,
  },
  { path: '/useRequest/ready', name: 'useRequestReady', component: Ready },
  {
    path: '/useRequest/refreshDeps',
    name: 'useRequestRefreshDeps',
    component: RefreshDeps,
  },
  {
    path: '/useRequest/debounce',
    name: 'useRequestDebounce',
    component: Debounce,
  },
  {
    path: '/useRequest/throttle',
    name: 'useRequestThrottle',
    component: Throttle,
  },
  { path: '/useRequest/retry', name: 'useRequestRetry', component: Retry },
];
